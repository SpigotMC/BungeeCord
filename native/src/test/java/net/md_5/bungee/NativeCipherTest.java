...
public class NativeCipherTest
{
    ...
    private final int benchmarkCount = 10000;
    ...
    public void testBenchmark(BungeeCipher cipher) throws Exception {
        ...
        System.out.println( String.format( "Encryption Iteration: %d, Elapsed: %d ms", benchmarkCount, time ) );
        ...
        System.out.println( String.format( "Decryption Iteration: %d, Elapsed: %d ms", benchmarkCount, time ) );
