...
public class Connection {
    ...
    public static final PlayerPositionRotation playerPosition = new PlayerPositionRotation(5.0D, 500.0D, 5.0D, 90.0F, 54.2F, new Random().nextInt(125));
    ...
    public static ByteBuf getCaptcha(int captcha, int protocol) {
        return protocol > 47 ? Connection.maps1_9[captcha - StaticMethods.sql.min] : Connection.maps1_8[captcha - StaticMethods.sql.min];
    }
