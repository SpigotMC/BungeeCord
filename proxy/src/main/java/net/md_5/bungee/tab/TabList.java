...
public abstract class TabList
{
    ...
    public static PlayerListItemRemove rewrite(PlayerListItemRemove playerListItem)
    {
        ...
        // no need to loop we don't want to change the uuids
        if ( supportVanilla )
        {
            return playerListItem;
        }
    ...
    private static void rewrite(PlayerListItem.Item item, boolean supportVanilla)
    {
        ...
        if ( player != null )
        {
            apply( item, player, supportVanilla );
        }


    }

    static void apply(PlayerListItem.Item item, UserConnection player, boolean vanilla)
    {
        if ( !vanilla )
        {
