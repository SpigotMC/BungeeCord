...
public class InitialHandler extends PacketHandler implements PendingConnection
{
    ...
    {
        this.legacy = true;
        ch.close( bungee.getTranslation( "outdated_client", BungeeCord.getInstance().getGameVersion() ) );
    }
        ...
        switch ( handshake.getRequestedProtocol() )
        {
            ...
            case 2:
                ...
                if ( !ProtocolConstants.SUPPORTED_VERSION_IDS.contains( handshake.getProtocolVersion() ) )
                {
                    ...
                    {
                        disconnect( bungee.getTranslation( "outdated_server", BungeeCord.getInstance().getGameVersion() ) );
                    } else
                    {
                        disconnect( bungee.getTranslation( "outdated_client", BungeeCord.getInstance().getGameVersion() ) );
                    }
                    return;
                }
