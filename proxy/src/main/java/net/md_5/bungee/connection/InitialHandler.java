            ...
            public void done(ProxyPingEvent result, Throwable error)
            {
                ...
                if ( v1_5 )
                {
                    kickMessage = ChatColor.DARK_BLUE
                            ...
                            + '\00' + legacy.getPlayers() != null ? String.valueOf( legacy.getPlayers().getOnline() ) : "-1"
                            + '\00' + legacy.getPlayers() != null ? String.valueOf( legacy.getPlayers().getMax() ) : "-1";
                } else
                {
                    ...
                    kickMessage = ChatColor.stripColor( getFirstLine( legacy.getDescription() ) )
                            + '\u00a7' + legacy.getPlayers() != null ? String.valueOf( legacy.getPlayers().getOnline() ) : "-1"
                            + '\u00a7' + legacy.getPlayers() != null ? String.valueOf( legacy.getPlayers().getMax() ) : "-1";
                }
