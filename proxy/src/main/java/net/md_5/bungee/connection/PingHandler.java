...
public class PingHandler extends PacketHandler
{
    ...
    public void connected(ChannelWrapper channel) throws Exception
    {
        ...
        channel.getHandle().pipeline().addAfter( PipelineUtils.FRAME_DECODER, PipelineUtils.PACKET_DECODER, new MinecraftDecoder( Protocol.STATUS, false, ProxyServer.getInstance().getProtocolVersion(), channel.getHandle().attr( PipelineUtils.SHUTDOWN ).get() ) );
