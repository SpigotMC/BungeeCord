...
public class BungeeCord
{
    ...
    /**
     * Broadcasts a plugin message to all servers with currently connected players.
     *
     * @param channel name
    ...
    /**
     * Send a plugin message to a specific server if it has currently connected players.
     *
     * @param channel name
     * @param message to send
