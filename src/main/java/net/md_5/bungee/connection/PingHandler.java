...
public class PingHandler extends PacketHandler {
    ...
    public void connected(ChannelWrapper channel) throws Exception {
        ...
        channel.getHandle().pipeline().addAfter(PipelineUtils.FRAME_DECODER, PipelineUtils.PACKET_DECODER, new MinecraftDecoder(false, Protocol.STATUS, ProxyServer.getInstance().getProtocolVersion()));
