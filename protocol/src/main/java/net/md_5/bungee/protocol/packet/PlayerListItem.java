...
public class PlayerListItem extends DefinedPacket<PlayerListItem>
{
    ...
    @Override
    public void callHandler(AbstractPacketHandler handler, PacketWrapper<PlayerListItem> packet) throws Exception
    {
        handler.handlePlayerListItem( packet );
    }
