...
public class ClientSettings extends DefinedPacket<ClientSettings>
{
    ...
    @Override
    public void callHandler(AbstractPacketHandler handler, PacketWrapper<ClientSettings> packet) throws Exception
    {
        handler.handleClientSettings( packet );
    }
}
