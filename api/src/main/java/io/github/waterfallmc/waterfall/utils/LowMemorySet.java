...
/**
 * A set that uses a <a href=>binary search</a> to find objects in a
 * <a href=https://en.wikipedia.org/wiki/Sorted_array>sorted array</a>. Avoids
 * the memory cost of {@link java.util.HashSet}, while maintaining reasonable
 * {@link Set#contains}
